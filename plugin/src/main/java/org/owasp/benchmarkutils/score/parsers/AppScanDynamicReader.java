...
public class AppScanDynamicReader extends Reader {
    ...
    public TestSuiteResults parse(ResultFile resultFile) throws Exception {
        ...
        //          </testTechnicalDescription>
        //          <causes>
        //            <cause>The web server or application server are configured in an insecure
        // way</cause>
        //          </causes>
        //          <securityRisks>
        //          </securityRisks>
        ...
        //          </affectedProducts>
        //          <cwe>
        //            <link target="http://cwe.mitre.org/data/definitions/297.html"
        // id="CWE-297">297</link>
        //          </cwe>
        //          <xfid>
        ...
        for (Node issueType : issueTypeList) {
            try {
                ...
                // System.out.println( "Found an issueType with no CWE link: " + getAttributeValue(
                // "ID", issueType ));
            }
        }
    ...
    private TestCaseResult parseAppScanDynamicVulnerability(
            Node issue, Map<String, Integer> cweMap) {
