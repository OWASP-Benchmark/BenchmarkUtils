...
import org.owasp.benchmarkutils.helpers.PropertiesManager;
...
class WriteFiles {
    ...
    // TODO: Refactor hard coded uses of Benchmark name to use configurable value based on name of
    // test suite
    // being worked with. Here and in next method.
    public void deletePreviousResults(
            String toolName, String toolVersion, String testSuiteVersion) {
        if (!toolName.equals("")) {
    ...
    public void resultsFileName(
            String tool, String testSuiteVersion, String times, String toolVersion) {
        String name =
                "results/Benchmark_"
                        + testSuiteVersion
                        + "-"
                ...
                file =
                        new File(
                                "results/"
                                        + findFile(
                                                "results",
                                                CONTRAST_FILE + testSuiteVersion + "-Contrast"));
                if (file.exists()) {
                    file.renameTo(
                            new File(
                                    "results/"
